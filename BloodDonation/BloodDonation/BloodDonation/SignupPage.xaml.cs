...
namespace BloodDonation
{
    ...
    public partial class SignupPage : ContentPage
    {
        ...
        //    var response = httpClient.PostAsync()("http://localhost:40312/api/signupclasses1");
        ...
        {
            var selectedValue = PkrSignupBloodGroup.Items[PkrSignupBloodGroup.SelectedIndex];
        }
    }
}
