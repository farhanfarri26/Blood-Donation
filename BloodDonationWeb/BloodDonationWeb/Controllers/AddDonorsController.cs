...
namespace BloodDonationWeb.Controllers
{
    public class AddDonorsController : Controller
    {
        ...
        //public ActionResult Index(string city = null, string area = null, string bloodGroup = null)
        //{
        //    if (city != null && area != null && bloodGroup != null)
        //    {
        //        var a = View(db.AddDonors.Where(x => x.City == ).ToList());
        //        return a;
        //    }
        //    else
        //    {
