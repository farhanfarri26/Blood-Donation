...
namespace MVCWebApi.Controllers.Api
{
    public class AddRequestsApiController : ApiController
    {
        ...
        {
            return db.AddRequests.OrderByDescending(m => m.Id);
        }


        //GET: api/AddRequestsApi?blood=
        [ResponseType(typeof(AddRequest))]
        public IHttpActionResult GetAddRequest(string blood)
        {
            ...
            return Ok(db.AddRequests.Where(x => x.BloodGroup == blood).OrderByDescending(m => m.Id));
        }
